...
class Config:
    ...
    norm_eps: float = 1e-5
    mlp_class_name: Literal["GptNeoxMLP", "LLaMAMLP", "LoRALLaMAMLP", "GemmaMLP", "LLaMAMoE"] = "GptNeoxMLP"
    ...
    # Added for chain forward
    first_recur_layer: Optional[int] = None
    last_recur_layer: Optional[int] = None
    max_depth: Optional[int] = None
    looping_strategy: Optional[str] = "cycle"
    num_loops: Optional[int] = None
    lora_rank: Optional[int] = None
    lora_attn_rank: Optional[int] = None
    lora_alpha: Optional[float] = None
    lora_attn_alpha: Optional[float] = None

    # HC params
    n_res_streams: Optional[int] = None
    mix_rs_after_loops: bool = False
    mix_rs_after_layers: bool = True
    mix_rs_every_l_layers: Optional[int] = None
    rs_mixing_strat: Optional[str] = "identity"
    premap_mixing_strat: Optional[str] = "default"
    postmap_mixing_strat: Optional[str] = "default"
    duplicate_init_res_proj: bool = False
    init_res_proj_rank: Optional[int] = None
    average_fin_res_proj: bool = False
    fin_res_proj_rank: Optional[int] = None
    add_premap_pos_embeds: bool = False
    add_postmap_pos_embeds: bool = False
    use_mhc: bool = False
    ...
    def mlp_class(self) -> Type:
        ...
        import litgpt_model
        return getattr(litgpt_model, self.mlp_class_name)
    ...
    def norm_class(self) -> Type:
        ...
        if self.norm_class_name == "RMSNorm":
            ...
            from litgpt_model import RMSNorm
